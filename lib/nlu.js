...
class nluWatson {
    ...
    analyzeAllReviews(reviews, keywordString) {
        ...
        for (let i = 0; i < reviews.length; i++) {
            reviewStr += ' Another author titled their review ' + reviews[i].reviewTitle + ' and said the following: ' + reviews[i].reviewText;
        }
        ...
        if (keywordString) {
            ...
            if (keywordArray.length === 3) {
                ...
                // for (let i = 0; i < reviews.length; i++) {
                //     reviewStr += ' Another author titled their review ' + reviews[i].reviewTitle + ' and said the following: ' + reviews[i].reviewText;
                //     let analysis = this.analyzeReviews(reviewStr, keyword1, keyword2, keyword3);
