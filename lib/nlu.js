...
class nluWatson {
    ...
    analyzeAllReviews(sortedReviews, keywordString) {
        ...
        console.log(`keywordString: ${keywordString}`);
                ...
                console.log("sortedReviews above");

                for (let i = 0; i < sortedReviews.length; i++) {
                    reviewStr += ' \nAnother author titled their review "' + sortedReviews[i].reviewTitle + '" and wrote: "' + sortedReviews[i].reviewText + '"\n.';
                }
