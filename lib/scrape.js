...
class Scrape {
        ...
        for (let page = 1; page <= (Math.ceil(totalReviewCount / 10)); page++) {
            ...
            axios.get(queryURL).then((response) => {
                ...
                if (numReviews === parseInt(totalReviewCount)) {
                    this.deleteAllInMongo(amazonReviewText, amazonRating, amazonAuthor, amazonReviewDate);
                }
    ...
    deleteAllInMongo(amazonReviewText, amazonRating, amazonAuthor, amazonReviewDate) {
