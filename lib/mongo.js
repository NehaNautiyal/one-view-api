...
class Mongo {
    ...
    async sortReviewsInMongo() {
        ...
        // current error: sort() only takes 1 Argument
        const sortedReviews = await db.Review.find({}, (err, result) => {
            return result
        }).sort({ reviewTitle: 1 });
        
        return sortedReviews
        // const data = await db.Review.find().sort({ reviewTitle: 1 });]
        // let result = await sortedReviews;
        // console.log("Sorted Reviews HERE: ", result);
        // return data;
        //     , function(err, sortedReviews) {
        //     if (err) {
        //         console.log(err);
        //     } else {
        //         console.log(sortedReviews);
        //         console.log("sortedReviews in sortReviews function");
        //         return sortedReviews;
        //     }
        // })
